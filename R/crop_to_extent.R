...
#'
#' @description This function crops an input raster layer (.tif) given a bounding 
#' box (xmin, ymin, xmax, ymax coordinates or a spatial object from which to extract
#' a bounding box) or to the boundary of a polygon vector layer (cutline source). 
#' The cropping is performed directly on disk, i.e. the input layer does not need 
#' to be loaded into R. The output is always written to disk, and can be
