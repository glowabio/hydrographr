...
#'
#' @description The "sudo apt-get update" command updates the package lists from the
#' repositories to ensure that the system has the latest information about
...
#'
#' @note
#'#' Sometimes VPN connections block the downloading of necessary updates. We thus
#' recommend to run this function outside any VPN connection.
#'
