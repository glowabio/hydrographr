...
#' @param order The neighbouring order as in igraph::ego. Order=1 would be immediate neighbours of the input segementID, order=2 would be the order 1 plus the immediate neighbours of those segementIDs in order 1, and so on.
#' @param mode One of "in", "out", or "all". "in" reports only upstream neighbouring segments, "out" reports only the downstream segments, and "all" does both.
