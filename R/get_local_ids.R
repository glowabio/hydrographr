...
get_local_ids <- function(df = NULL, csv_url = NULL,
  ...
  # Define URL for multi-point processing
  url <- "https://aqua.igb-berlin.de/pygeoapi-dev/processes/get-local-subcids-plural/execution"
