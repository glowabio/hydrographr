...
**GDAL/ORG and pktools**

For GDAL, go to the GDAL webpage and [download](https://gdal.org/download.html#current-release) the last release for Ubuntu. For pktools go to the pktools webpage and [download](https://pktools.nongnu.org/html/md_installation_linux.html#install_manual) the install_pktools.sh file.

```{bash, eval=FALSE}
# Go (with cd) to your mounted Windows Downloads folder
