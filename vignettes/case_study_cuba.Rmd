...
bibliography: /home/afroditi/Documents/PhD/scripts/hydrographr/man/references.bib
link-citations: yes
linkcolor: blue
# csl: copernicus.csl
nocite: '@*'
...
```{r}
spdata <- fread(paste0(wdir, "/data_cuba/spdata_cuba.csv"), sep = "\t", fill = TRUE) %>% 
...
```{r}
dirs_chelsa <- list.dirs(paste0(wdir, "/data_cuba/chelsa_bioclim"),
