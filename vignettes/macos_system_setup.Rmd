...
To install GDAL, you should follow this installation guide: [GDALinst](https://mits003.github.io/studio_null/2021/07/install-gdal-on-macos/)
...
First, you need to download the latest stable release of GRASS GIS from [GRASS GIS download](http://grassmac.wikidot.com/downloads).
Afterwards:
