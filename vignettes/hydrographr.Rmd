...
Since the `hydrographr` package is optimized to run in a Linux operating system, in a Windows environment some additional software needs to be installed (see [Windows system setup](https://glowabio.github.io/hydrographr/articels/windows_system_setup.html)).
...
[Linux](https://glowabio.github.io/hydrographr/articels/linux_system_setup.html)

[Windows](https://glowabio.github.io/hydrographr/articels/windows_system_setup.html)
