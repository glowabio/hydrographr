...
Yellow sub-catchments have the lowest values, whereas dark blue have the
lowest values for the different metrics.

![betweenness centrality](../man/figures/betweeness.png)

![degree centrality](../man/figures/degree.png) degree
centrality![farness](../man/figures/farness.png)
farness![eccentricity](../man/figures/eccentricity.png)eccentricity
