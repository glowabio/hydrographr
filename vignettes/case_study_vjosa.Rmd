...
species_snap <- api_get_snapped_points(csv_spdata_url,
                               # colname_lat = "latitude",
                               colname_lon = "longitude",
                               colname_site_id = "site_id",
...
one_point_df <- slice(species_snap,1) %>% 
...
```{r, eval = FALSE}
# For species points
upstr_ids_spdata <- api_get_upstream_subcids(species_snap, 
                        colname_lat = "latitude_snapped", 
                        colname_lon = "longitude_snapped",
...
# For dam points
upstr_ids_dams <- api_get_upstream_subcids(dams_snap, 
                        colname_lat = "latitude_snapped", 
                        colname_lon = "longitude_snapped",
                        process_url = get_upstream_ids_url) %>%
                        as.data.table()
...
env_data_basin <- api_get_env90m_data(
  subc_ids = head(spdata_ids$subc_id),
