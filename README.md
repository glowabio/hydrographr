...
<img src="man/figures/function_description_20251211.png" align="left" />
...
library(hydrographr)
```
The pdf manual of the `hydrographr` package can be downloaded [here](https://github.com/glowabio/hydrographr/tree/main/man/pdf/hydrographr_1.5.0.pdf).
