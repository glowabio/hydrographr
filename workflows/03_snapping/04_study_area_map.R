#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
# 04_study_area_map.R   (Module 3 -- Snapping)
#
...
#
# Output:
#   - figures/study_area_map.pdf
#
# LOCATION: workflows/03_snapping/04_study_area_map.R
#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
...
COL_SURVEY <- "#009E73F2"   # bluish green -- survey fish
COL_GBIF   <- "#009E73F2"   # bluish green -- GBIF fish
COL_DAM_E  <- "#D55E00FF"   # vermillion   -- existing dam
COL_DAM_P  <- "#D55E00FF"   # vermillion   -- planned dams
COL_BASIN  <- "#2166ac"     # blue         -- Aoos/Vjosa basin (inset)
COL_RECT   <- "#D55E00FF"   # vermillion   -- sub-basin extent rectangle (inset)
...
# ============================================================
# RESTRICT POINTS TO THE SARANTAPOROS SUB-BASIN
# ============================================================

message("Filtering points to the Sarantaporos sub-basin...")

fish_survey   <- sf::st_filter(fish_survey, subbasin)
fish_gbif     <- sf::st_filter(fish_gbif, subbasin)
dams_existing <- sf::st_filter(dams_existing, subbasin)
dams_planned  <- sf::st_filter(dams_planned, subbasin)
...
message("Saved: figures/study_area_map.pdf")
